	...
	<div class="nav-top">
		...
		<div id="upload_icons">
			...
			<svg id="icon" class="bi bi-image" width="1em" height="1em"
				...
				onClick="location.href='/leesfilm/upload'">
			...
			<svg id="icon" width="1em" height="1em" viewBox="0 0 16 16"
				...
				xmlns="http://www.w3.org/2000/svg"
				onClick="location.href='/leesfilm/editCategory'">
  				<path fill-rule="evenodd"
			...
			<svg id="icon" class="bi bi-people-circle" width="1em" height="1em"
				viewBox="0 0 16 16" fill="currentColor"
				xmlns="http://www.w3.org/2000/svg"
				onClick="location.href='/leesfilm/logout'">
  				<path
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto my-2 my-lg-0">
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="/leesfilm/photo">Photo</a> <!-- 은비가 db에서 카테고리 명 갖고 오는 방법 알려주면 그 때 맞게 적용하기 -->
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="/leesfilm/films">Films</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
   ...
   <jsp:include page="header.jsp"></jsp:include> --%>
	...
	<c:forEach items="${resultFilmMap}" var="filmMap">
		...
		<div class="videos" id="v0">
			<a href="https://www.youtube.com/watch?v=${film_name}" class="video"
				title="${film_id}"> <span>&nbsp;</span> <img
				src="http://i1.ytimg.com/vi/${film_name}/maxresdefault.jpg" />
			</a>
		</div>
	</c:forEach>
